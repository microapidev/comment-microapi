...
describe("GET /comments/:commentId/replies/:replyId", () => {
  beforeEach(async () => {
    ...
    const mockedReply2Doc = new ReplyModel({
      ...
      upVotes: [],
      downVotes: [mockedCommentDoc.ownerId],
    });
    ...
    //Mock voting
    mockedReply1Doc.upVotes.push("newvoter@gmail.com");
    mockedReply1Doc.downVotes.push("anothervoter@gmail.com");
    totalVotes = mockedReply1Doc.upVotes.concat(mockedReply1Doc.downVotes);

    mockedReply2Doc.upVotes.push("chivoter@gmail.com");
    mockedReply2Doc.downVotes.push("avoter@gmail.com");
  ...
  it("should get a single reply and all its votes", async () => {
    ...
    expect(res.body.data.numOfUpVotes[0]).toEqual(reply1.numOfUpVotes[0]);
    expect(res.body.data.numOfDownVotes[0]).toEqual(reply1.numOfDownVotes[0]);
    expect(res.body.data.numOfUpVotes + res.body.data.numOfDownVotes).toEqual(
      totalVotes.length
    );
  });
  ...
  it("should return 422 for invalid replyId", async () => {
    const replyId = "5khsif9fao0840664ht38";
